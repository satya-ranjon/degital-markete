...
const ServiceSection = () => {
  return (
    <SectionLayout>
      <div className=" py-20 md:py-[126px]">
        <div className="flex flex-col md:flex-row justify-between items-start gap-5 md:gap-0 md:items-center">
          <div>
            ...
            <SectionTitle className="mt-2">from me</SectionTitle>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 xl:gap-[122px] mt-16 xl:max-w-[1080px] xl:float-right ">
